...
select org, course_key, display_name, course_start, course_end,
enrollment_start, enrollment_end, self_paced,
 course_data_json, created, modified, dump_id, time_last_dumped
